...
class TestExchange(TestCase):
    ...
    def test_open_order(self):
        ...
        self.assertTrue(len(e.book.ask)==0,"Ask table not resolved")
        self.assertTrue(len(e.book.bid)==1,"Bid order deleted")
    ...
    def test_cancel_order(self):
        ...
        loop.run_until_complete(asyncio.wait(tasks))
        self.assertTrue(len(e.book.bid)==0,"Order was not canceled")
    ...
    def test_set_callbacks(self):
        ...
        self.assertEqual(self.datastream_report[2][3],150,"Order matched at wrong price")
